...
function getcollabSessionStorage() {
    var d = collabSessionStorage.getItem('data');
    var data = JSON.parse(d);
    return data;
}

function setcollabSessionStorage(data) {
    if (data) {
        var dataToStore = JSON.stringify(data);
        collabSessionStorage.setItem('data', dataToStore);
    }
}

function getFirebaseCollaborationData() {
    var tTableStartPerformance = performance.now();
    var sData = getcollabSessionStorage();
    if (sData) {
        _collab_data = sData;
        hydrateView();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            setcollabSessionStorage(_collab_data);
        }
    });
}
