...
function createFilterFor(key) {
    ...
    for (var i = 0; i < options.length; i++) {
        // SOLELY FOR THE PURPOSE OF HIDING EXTRA BUSINESS/BUSINESSES CATEGORIES UNTIL WE FIGURE OUT WHAT TO DO WITH THEM
    	if (options[i] === 'Ngo' || options[i] === 'Business' || options[i] === 'Businesses' || options[i] === 'Business & Private Sector') {
    	} else {
